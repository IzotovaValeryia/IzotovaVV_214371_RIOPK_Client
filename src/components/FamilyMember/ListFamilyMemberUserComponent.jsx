...
class ListFamilyMemberComponent extends Component {
  ...
  editFamilyMember(id) {
    this.props.history.push(`/update-familymember-user/${id}`);
    window.location.reload();
  }

  addFamilyMember() {
    this.props.history.push("/add-familymember-user");
    window.location.reload();
  }

  componentDidMount() {
    FamilyMemberService.getFamilyMemberByApplicationUserId(JSON.parse(localStorage.getItem("user")).idUser)
      .then((res) => {
        this.setState({
